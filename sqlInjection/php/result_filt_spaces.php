<!--
    AUTHOR:Ren Xujie
    DATE:2018-5-15
    PROJECT:SQL injection with method filter spaces
-->
...
if($num_result >1 or $uapar){
    ...
    echo "<a href='../html/login_addsls.html' style='color:yellow;'>下一关&#160<i class='fas fa-arrow-right'></i></a>";
    echo '<p><font face="楷体"> &#160&#160&#160&#160提示：下一关我们将采用将某些特殊符号（如单引号"\'"、反斜杠"\\"）转义的方式进行防注入。</p>';
}
?>
</body>
</html>
